...
enum heif_color_profile_type
{
  ...
  heif_color_profile_type_nclx = (('n' << 24) | ('c' << 16) | ('l' << 8) | 'x'), // heif_fourcc('n', 'c', 'l', 'x'),
  heif_color_profile_type_rICC = (('r' << 24) | ('I' << 16) | ('C' << 8) | 'C'), // heif_fourcc('r', 'I', 'C', 'C'),
  heif_color_profile_type_prof = (('p' << 24) | ('r' << 16) | ('o' << 8) | 'f')  // heif_fourcc('p', 'r', 'o', 'f')
};
